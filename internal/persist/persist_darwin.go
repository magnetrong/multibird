...
func Install(name, multibirdBin, configRoot string) (string, error) {
	...
	if err := os.WriteFile(path, []byte(LaunchdPlist(name, multibirdBin, configRoot)), 0o644); err != nil {
...
func InstallDNSWatch(name, multibirdBin, configRoot string) (string, error) {
	...
	if err := os.WriteFile(path, []byte(LaunchdDNSWatchPlist(name, multibirdBin, configRoot)), 0o644); err != nil {
